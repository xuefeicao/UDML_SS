...
def BN_Inception(dim=512, pretrained=True, self_supervision_rot=0, model_path=None):
    model = BNInception(dim=512, self_supervision_rot=self_supervision_rot)
    if model_path is None:
        model_path = '/private/home/xuefeicao01/metric_learning/Deep_Metric_without_label/pretrained/bn_inception-52deb4733.pth'
